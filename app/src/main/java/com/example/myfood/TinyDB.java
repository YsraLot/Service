...
public class TinyDB {
    ...
    public ArrayList<FoodD> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodD> playerList =  new ArrayList<FoodD>();

        for(String jObjString : objStrings){
            FoodD player  = gson.fromJson(jObjString,  FoodD.class);
    ...
    public void putListObject(String key, ArrayList<FoodD> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodD player: playerList){
